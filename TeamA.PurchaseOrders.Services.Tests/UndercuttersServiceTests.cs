...
namespace TeamA.PurchaseOrders.Services.Tests
{
    public class UndercuttersServiceTests
    {
        ...
        private Mock<ILogger<UndercuttersService>> _mockLogger;
        ...
        public void Setup()
        {
            ...
            _mockLogger = new Mock<ILogger<UndercuttersService>>();
            _undercuttersService = new UndercuttersService(_httpClient, _mockHttpClientFactory.Object, _mockLogger.Object);
        ...
        public async Task GetProducts_Success()
        {
            ...
            // Act
            var result = await _undercuttersService.GetProducts();
        ...
        public async Task GetProducts_Fails_EmptyList()
        {
            ...
            // Act
            var product = await _undercuttersService.GetProducts();
        ...
        public async Task GetProductById_Success()
        {
            ...
            // Act
            var product = await _undercuttersService.GetProduct(It.IsAny<int>());
        ...
        public async Task CreateOrder_Valid_Success()
        {
            ...
            // Act
            var order = await _undercuttersService.CreateOrder(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>());
